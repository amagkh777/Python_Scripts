...
kwargs={'min_len': 4, 'check_numbers': True}
username='user1' password='sdkfhjsaldfh35' min_len=4
username='user2' password='sdkf' min_len=4
username='user3' password='sdfssfdkjhkjuser3' min_len=4
[]
['user1', 'user2', 'user3']
